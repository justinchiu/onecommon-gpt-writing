...
\maketitle
\begin{abstract}
Large language models have demonstrated strong reasoning capabilities on textual tasks.
Recent work has shown that, when given access to tools such as a code interpreter and
vision models,
language models are also able to reason about grounded phenomena with minimal supervision.
In this work, we explore the use of tool-based language models for grounded dialogue.
We build a modular dialogue system that represents dialogue state as executable code.
The dialogue system has three components: a reader, planner, and writer.
