...
\textsc{Start} begins a topic,
\textsc{follow-up} follows up on a topic,
and \textsc{select} communicates the intent to end the game.
Utterances may not correspond to any of these dialogue acts, which we label \textsc{None}.
